...
from dm import chrome_option_initate, log_info, naver_login, dmain_member_fashion, dmain_member_fashion_get, \
...
if __name__ == '__main__':
    ...
    page_num = 1
    today = str(dt.datetime.today() - dt.timedelta(days=4)).split(' ')[0]
    ...
    while iteration == True :
        ...
        for i, row in df_new_url.iterrows():
            ...
            if row['date'] > (dt_today - dt.timedelta(days=1)) :
                pass
    ...
    df_result = dmain_member_fashion_get(driver, df_url, dt_today)
    ...
    df_result = dmain_member_product_get(driver, df_url, dt_today)
    db_insert(lst_db_info, df_result)
    print(df_result)

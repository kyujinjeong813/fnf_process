...
def api_con_exe(startDate, endDate, period):
    ...
    # target_keyword 엑셀 파일에 검색어 입력, 저장 후 닫아주세요
    df_search = pd.read_excel("target_keyword.xlsx", sheet_name = 'Sheet1')
    df_search.dropna(thresh=1).iloc[:, 0:21]
...
if __name__ == '__main__':
    ...
    df_week['weeknum'] = df_week['date'].dt.week
    ...
    df_result.to_excel('target_result_day.xlsx')
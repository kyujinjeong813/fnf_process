...
from koear_news_crawler.writer import Writer
import os
import platform
import calendar
import requests
...
class ArticleCrawler(object):
    def __init__(self):
        self.categories = {'정치':100, '경제':101, '사회':102, '생활문화':103, '세계':104, 'IT과학':105,
                           '오피니언':110, 'politics':100, 'economy':101, 'society': 102, 'living_culture': 103, 'world': 104, 'IT_science': 105, 'opinion': 110}
        ...
        for year in range(start_year, end_year + 1):
            ...
            for month in range(year_startmonth, year_endmonth + 1):
                for month_day in range(1, calendar.monthrange(year, month)[1] + 1):
                    ...
                    #네이버 페이지 구조 이용 : 아주 큰 숫자 입력하면, 맨 마지막 페이지를 알아서 소환해줌ㅋ
        ...
        for URL in day_urls:
            ...
            for content_url in post:
                ...
                try:
                    ...
                    wcsv.writewor([news_date, category_name, text_company, text_headline, text_sentence, content_url])
...
if __name__ == "__main__":
    ...
    Crawler.set_date_range(2019, 1, 2020, 7)
    Crawler.start()
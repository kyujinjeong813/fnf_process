...
def fetch_comments(browser, dict_post):
    ...
    show_more_selector = ".glyphsSpriteCircle_add__outline__24__grey_9"
    # show_more_selector = ".dCJp8"
    ...
    # show_comment_btns = browser.find("div .Igw0E .y3zKF")
    ...
    for els_comment in ele_comments[1:]:
        author = browser.find_one("._6lAjh", els_comment).text #수정함 / 안되면 h3태그
